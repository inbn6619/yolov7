...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            canvas = cv2.imread('/home/ubuntu/minimap_png(미니맵용)ver02.png')
            ...
            if len(det):
                ...
                for num in range(len(tracked_targets)):
                    ...
                    nowdict[str(track_id)] = [xm, ym, xM, yM]
                    ...
                    if tracked_targets[num].track_id in contrail_dict.keys():
                        ...
                        # contrail 그리기
                        im0=tracking_tail(contrail_dict[track_id], im0, colors[track_id % len(colors)], meal_amount, water_intake)


                        canvas = minimap_tail(contrail_dict[track_id], canvas, colors[track_id % len(colors)], meal_amount, water_intake)
                    ...
                    plot_one_box_tracked(tracked_targets[num], xc, yc, meal_amount, water_intake,track_id, im0, canvas, colors[track_id % len(colors)])
                ...
                if dataset.mode == 'image':
                    ...
                    if vid_path != save_path:  # new video
                        ...
                        if vid_cap:  # video
                            ...
                            save_path += '.mp4'
                        vid_writer = cv2.VideoWriter(save_path, fcc, fps, out_size)
